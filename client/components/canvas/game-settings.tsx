...
const GameSettings = () => {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-[#d3d3d359] dark:bg-[#35394a] text-black">
      ...
      <Card className="w-[90vw] max-w-[400px] dark:bg-[#020817] dark:border-[#1e293b] border-[#d1d2d3]">
        <CardHeader>
